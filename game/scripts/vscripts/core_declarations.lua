...
SMASH_BROS_MODE = true
EXPERIMENTAL_POWERUPS = true

PLAYER_COLORS = {}

PLAYER_COLORS[DOTA_TEAM_GOODGUYS] = Vector(100, 100, 255)
PLAYER_COLORS[DOTA_TEAM_BADGUYS] = Vector(255, 100, 100)
PLAYER_COLORS[DOTA_TEAM_CUSTOM_1] = Vector(100, 255, 100)
PLAYER_COLORS[DOTA_TEAM_CUSTOM_2] = Vector(255, 100, 255)